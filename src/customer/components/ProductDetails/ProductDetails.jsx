        ...
        <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
          ...
          <div className="flex flex-wrap space-x-5 justify-center">
            ...
            <img
              alt={item.alt}
              src={item.src}
              className="h-full w-full objet-cover object-center"
            />
            </div>) }
        ...
        <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
                ...
                <p className='ml-3 text-sm font-medium text-indig-600 hover:text-indigo-500'> 3870 Reviews</p>
                </div>
    ...
    <Grid container spacing={7}>
        ...
        <Grid item xs={5}>
            ...
            <Box className="mt-5 space-y-3">
                <Grid container justifyContent="center" alignItems="center" gap={2}></Grid>
                <Grid item xs={2}>
                    <p>Excellent</p>
                </Grid>
                <Grid item xs={7}>
                ...
                <Grid item xs={7}>
                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,height:7,color:"yellow"}} variant="determinate" value={40} />
                </Grid>
