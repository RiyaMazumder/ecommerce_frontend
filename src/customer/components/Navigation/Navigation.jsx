...
<div className="ml-4 flex lg:ml-0">
  ...
  <img
    src="https://dynamic.design.com/preview/logodraft/ea8e4683-4db4-4776-9935-63588c4802bd/image/large.png"
    alt="ShopwithBuyLoom"
...
<div className="ml-4 flow-root lg:ml-6">
  <Button className="group -m-2 flex items-center p-2">
    <ShoppingBagIcon
      aria-hidden="true"
      className="h-6 w-6 shrink-0 text-gray-400 group-hover:text-gray-500" // Fixed className
    />
